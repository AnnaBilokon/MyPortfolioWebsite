      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-[#ADB7BE] sm:text-lg mb-6 lg:text-xl">
            ...
            Developer and UX/UI Designer who is seeking an opportunity to
            contribute my knowledge into interesting projects. I am excited to
            be a part of a team that values creativity, innovation, and
            user-centric design.
          </p>
